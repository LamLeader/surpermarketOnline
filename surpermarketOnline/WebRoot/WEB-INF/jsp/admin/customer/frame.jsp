...
<body class="mobile">
	<form id="form1" name="form1" method="post" action="list.html"
		...
		<table class="mobile">
			...
			<tr class="pagesearch" height="5%">
				<td style="text-align: left;">&nbsp;&nbsp; 账号模糊查询： <input
					type="text" name="username" style="width:100px;">
					&nbsp;&nbsp; 姓名模糊查询： <input type="text" name="name"
					style="width:100px;"> <input type="button" class="btn"
					value="查 询 " onClick="sch();" /> &nbsp;&nbsp; <input type="button"
					class="btn" value="新 增 " onClick="add();" /> <c:choose>
	...
	<script>
		...
		function add() {
			MyWindow.OpenCenterWindow('edit.html?flag=${param.flag}', 'addOld',
					500, 600);
		}
	</script>
</body>
